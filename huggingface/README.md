...
**Repo:** [sentiantai/sharp-onnx-webgpu-weights](https://huggingface.co/sentiantai/sharp-onnx-webgpu-weights)
...
Production builds load weights from this repo by default. Optional overrides (Vercel → Environment Variables):
...
The app derives `.onnx.data` URLs from the graph path automatically.
